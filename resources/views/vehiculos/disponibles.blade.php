...
<body>
    ...
    <table class="summary" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td>
                <span class="summary-label">Capacidad total</span>
                <span class="summary-value">{{ $reporte['capacidad_total'] }}</span>
            </td>
            <td>
    ...
    @else
        <div class="empty">No existen vehículos disponibles para los filtros seleccionados.</div>
    @endif
