...
<body>
    ...
    <table class="summary" cellspacing="0" cellpadding="0">
        <tr>
            <td><span class="summary-label">Formas de pago</span><span
                    class="summary-value">{{ $reporte['total_registros'] }}</span></td>
            <td><span class="summary-label">N.º ventas</span><span
                    class="summary-value">{{ $reporte['total_ventas'] }}</span></td>
            <td><span class="summary-label">Asientos</span><span
        ...
        <table class="data">
            ...
            <tbody>
                ...
                <tr class="grand-total">
                    ...
                    <td class="right">{{ number_format($reporte['ingreso_total'], 2) }}</td>
                </tr>
            </tbody>
        </table>
    @else
        <div class="empty">No existen ingresos registrados en el rango seleccionado.</div>
    @endif
