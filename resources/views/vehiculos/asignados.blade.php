...
<body>
    ...
    <table class="summary" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td>
                <span class="summary-label">Choferes únicos</span>
                <span class="summary-value">{{ $reporte['choferes_unicos'] }}</span>
            </td>
            <td>
                <span class="summary-label">Tipo</span>
                <span class="summary-value">Asignados</span>
            </td>
        </tr>
    </table>
            ...
            <tbody>
                @foreach($reporte['items'] as $item)
                    ...
                    <tr>
                        ...
                        <td>{{ $nombre ?: '-' }}</td>
                        <td>{{ $item->chofer?->carnet_sindical ?? '-' }}</td>
                        <td>{{ $item->estado }}</td>
